...
def my_page(request):
    ...
    try:
        ...
        normalized_score = (user_score / 1000) * 100
    ...
    return render(request, 'mypage.html', {'uploaded_files': uploaded_files, 'user_score': user_score, 'normalized_score':normalized_score})